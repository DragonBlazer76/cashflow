                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="btnCancelEditMdl" name="btnCancelEditMdl" type="button" class="btn btn-3d btn-danger">Cancel Changes</button>
                                </div>
						...
						jQuery(".ui-icon.ui-icon-seek-end").removeClass().addClass("fa fa-fast-forward");
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12" style="text-align: right;">
                                            <button id="btn_cancel2" name="btn_cancel2" type="button" class="btn btn-3d btn-danger margin-top-30" data-toggle="modal" data-target="#cancel_editModal">
