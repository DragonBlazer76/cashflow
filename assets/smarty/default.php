			...
			<aside id="aside">
				...
				-->
                    <div class="text-center margin-left-20 margin-right-20 margin-top-10">
                        <img class="img-responsive margin-bottom-10" src="<?= (empty(Auth::user()->image))?template_url('/images/noavatar.jpg', ''):Auth::user()->image; ?>" alt="" style="width:80px;border-radius: 50%;" />
        ...
        <?php } ?>
			...
			<header id="header" style="border-bottom:1px solid;border-color:#ddd;">
				...
				<span class="logo pull-left tour-step tour-step-one">
					<img src="/templates/smarty/assets/images/cashflow_light.png" alt="admin panel" height="40" />
				</span>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown pull-left">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								<img class="user-avatar" alt="" src="<?= (empty(Auth::user()->image))?template_url('/images/noavatar.jpg', ''):Auth::user()->image; ?>" height="34" /> 
