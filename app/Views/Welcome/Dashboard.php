...
<?php
    ...
    Assets::js([
        ...
        template_url('plugins/toastr/toastr.js', 'smarty'),
        template_url('js/custom.js', 'smarty'),
        template_url('js/dashboard.js', 'smarty'),
        template_url('js/bootstrap-tour.min.js', 'smarty'),
    ]);
...
?>
            ...
            var tour = new Tour({
                        ...
                        onEnd: function () {
                            $.ajax({
                                ...
                                url         : '/updatesuppliersecondtime', // the url where we want to POST
                    ...
                    tour.addSteps([
                      ...
                      },
                      {
                        ...
                        content: "Here are the modules, easily laid out."
                      },
                      {
                        ...
                        backdrop: false,
                        title: "Invoice",
                        content: "Create your invoice first. This will allow the system to identify your supplier."
                      },
                      {
                        ...
                        backdrop: false,
                        title: "Auction",
                        content: "Next, create an auction with discount rate. This will notify your supplier to bid for their invoice."
                      },
                      {
                        ...
                        backdrop: false,
                        title: "Settings",
                        content: "You can set your profile here."
                      },
                      {
                        ...
                        backdrop: false,
                        title: "Notifications",
                        content: "You can check your notifications here too."
                      },
                      {
                        ...
                        backdrop: false,
                        title: "End of tour",
                        content: "Thank you for viewing the tour."
                      },
                    ]);
        ...
        <?php } ?>
                    <div id="firsttimeModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Welcome to Cashflow.to!</h4>
                                </div>

                                <!-- Modal Body -->
                                <div class="modal-body">
                                    <h4 id="lblCompany">Let's get your details correct, shall we? You could always change your company profile later.</h4>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="supplier_addr1" name="supplier_addr1"value="" required>
									</div>
                                    <div class="form-group">
										<label class="control-label">Address 2</label>
										<input type="text" class="form-control" id="supplier_addr2" name="supplier_addr2"value="">
									</div>
                                      <div class="form-group">
										<label class="control-label">State</label>
										<input type="text" class="form-control" id="supplier_state" name="supplier_state"value="">
									</div>
                                      <div class="form-group">
										<label class="control-label">Postal Code *</label>
										<input type="text" class="form-control" id="supplier_postal" name="supplier_postal"value="" required>
									</div>
									<div class="form-group">
...
<!--
									<div class="form-group">
										...
										<input type="text" class="form-control"id="supplier_email" name="supplier_email"value="" required>
									</div>
-->
									<div class="form-group">
										<label class="control-label">Phone 1 *</label>
										<input type="text" class="form-control" id="supplier_phone1" name="supplier_phone1"value="" required>
									</div>
                                    	<div class="form-group">
										<label class="control-label">Phone 2</label>
										<input type="text" class="form-control" id="supplier_phone2" name="supplier_phone2"value="">
									</div>
                                    	<div class="form-group">
										<label class="control-label">Credit Terms *</label>
										<input type="text" class="form-control" id="supplier_credit_terms" name="supplier_credit_terms"value="" required>
                                    </div>
								</form>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="btnOkMdl" name="btnOkMdl" type="button" class="btn btn-3d btn-info">Save Changes</button>
                                </div>
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>AMOUNT DISCOUNTED</strong> <!-- panel title -->
								<small class="size-12 weight-300 text-mutted hidden-xs"><?php echo strtoupper(date('M Y')); ?></small>
							</span>
