...
//        template_url('js/app.js', 'Smarty2'),
	...
	<body class="smoothscroll enable-animation">
		...
		<div id="wrapper">
				...
				<header id="topNav">
					<div class="container">
						...
						<a class="logo pull-left scrollTo" href="#top">
							<img src="<?= template_url('/images/cashflow5.png', "Smarty2"); ?>" alt="ca$hflow.to/." />
							<img src="<?= template_url('/images/cashflow4.png', "Smarty2"); ?>" alt="ca$hflow.to/." />
						</a>
			...
			<!-- SLIDER -->
			<section id="slider" class="fullheight parallax parallax-4" style="background-image:url('templates/smarty2/assets/images/demo/1200x800/12-min.jpg');">
						...
						<div class="container">
							...
							<div class="slider-featured-text text-center">
								<h1 class="text-white wow fadeInUp" data-wow-delay="0.4s">
                                    Welcome to Ca<label style="color:#30c5b5;display:initial;" class="weight-600">$</label>hflow.to/<label style="color:#30c5b5;display:initial;" class="weight-600">.</label>
								</h1>
								<h2 class="weight-300 text-white wow fadeInUp" data-wow-delay="0.8s">Take Your Business To The Next Level</h2>
							</div>
			...
			<section id="about">
				<div class="container">
					...
					<header class="text-center margin-bottom-60">
						<h2>We Are Ca$hflow.to/.</h2>
						<p class="lead font-lato">Start Ca$hflow.to/., You and your Business Partners</p>
						<hr />
					</header>
			...
			<section id="work">
				<div class="container">
					...
					<header class="text-center">
						<h2 class="nomargin">How does Ca$hflow.to/. works</h2>
					...
					<div class="tab-content margin-top-30">
						<div class="tab-pane active" id="step1">
							<strong>Reach</strong> Depending on your trade and working capital objectives, ca$hflow.to/. helps you reach out to your entire network of buyers and suppliers in a few easy clicks.
						</div>

						<div class="tab-pane" id="step2">
							<strong>User Friendly Interface</strong>  Cashflow.to/ is simple to use and accessible to non-boarded trade partners. Thus you and your trade network can immediately participate and enjoy the full benefits of Cashflow.to/.
						</div>
...
-->
	       ...
	       <div class="container">
				<header class="text-center">
						<h2 class="nomargin">Why buyers and suppliers love Ca$hflow.to/.</h2>
						<p class="font-lato size-20 nomargin">With Cashflow.to/, suppliers can now unlock cash in the supply chain by offering early payment discount.
                        </p>
				</header>
        ...
        <div class="row" style="padding-top:15px; padding-right:100px;">
			...
			<div class="back">
				<div class="box2">
						<h3>Ca$hFlow.to/. Buyer's flow</h3>
					<hr />
		...
		<div class="box-flip box-icon box-icon-center box-icon-round box-icon-large text-center">
			...
			<section id="features">
				<div class="container">
					...
					<header class="text-center margin-bottom-60">
						<h2>Our Features</h2>
						<p class="lead font-lato">We enable Cashflow.to be easier and smarter between businesses</p>
						<hr />
					</header>
			...
			<footer id="footer">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<!-- Footer Logo -->
							<img src="<?= template_url('/images/cashflow_invert.png', "Smarty2"); ?>" alt="ca$hflow.to/." />
						...
						<div class="col-md-3">
							...
							<!-- Links -->
							<h4 class="letter-spacing-1">EXPLORE CA$HFLOW.TO/.</h4>
				...
				<div class="copyright">
					<div class="container">
						...
						&copy; All Rights Reserved, Ca$flow.to/. Pte Ltd
					</div>
				</div>
			</footer>
			<!-- /FOOTER -->
...
<!--   DO NOT DELETE! - Forensics Profiler -->
    <script type="text/javascript">var plugin_path = 'templates/smarty2/assets/plugins/'</script>
